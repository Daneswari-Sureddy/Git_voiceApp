...
def run_alexa():
    ...
    try:
        command = recognizer.recognize_google(recorded_audio, language='en-in')
        ...
        if 'hello' in command:
            ...
            location, locate area on map,open different websites like instagram, youtube, send a whatsapp message,gmail,
             git hub, stack overflow and searches on google.How may i help you ??''')
            engine_talk('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find 
            your location, locate area on map,open different websites like insta gram, youtube,send a whatsapp message, 
